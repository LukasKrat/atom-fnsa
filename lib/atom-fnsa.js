    ...
    this.subscriptions.add(atom.project.onDidChangeFiles(events =>
    {
      ...
      for (const event of events)
      {
        ...
        if (event.action === 'created')
        {
          ...
          var dtM = (dt.getMonth()+1).toString().toString().length < 2 ? "0" + (dt.getMonth()+1).toString().toString() : (dt.getMonth()+1).toString().toString();
          var dtD = dt.getDate().toString().length < 2 ? "0" + dt.getDate().toString() : dt.getDate().toString();
